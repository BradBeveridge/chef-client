...
maintainer_email  'brad.beveridge@siemens.com'
license           'Apache-2.0'
...
source_url 'https://github.com/BradBeveridge/chef-client'
issues_url 'https://github.com/BradBeveridge/chef-client/issues'
